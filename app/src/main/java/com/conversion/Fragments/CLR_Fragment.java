...
public class CLR_Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_c_l_r, container, false);
        ...
        credentialValueTextView.setText("SNF");
        ...
        equalTo.setOnClickListener(v -> {
            ...
            if (!textOneEditText.getText().toString().isEmpty() && !textTwoEditText.getText().toString().isEmpty()) {
                ...
                String clrResult = String.valueOf(formula.clrCalculate(textOneEditText.getText().toString(), textTwoEditText.getText().toString(), STATE_TEM_VOLUME_1, STATE_TEM_VOLUME_2));


                // calculate total solid
                String tsResult = String.valueOf(formula.totalSolid(textOneEditText.getText().toString(), textTwoEditText.getText().toString()));
                ...
                Toast.makeText(getActivity(), "Enter SNF", Toast.LENGTH_SHORT).show();
            }
    ...
    public void onClick(View v) {
        ...
        if (credentialValueTextView.getText().toString().equals("SNF")) {
